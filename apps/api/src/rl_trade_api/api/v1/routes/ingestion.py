...
def request_ingestion(
    ...
    return ingestion_service.request_ingestion(session=session, principal=principal, payload=payload)
...
def retry_ingestion(
    ...
    return ingestion_service.retry_ingestion(session=session, principal=principal, job_id=job_id)
